...
class teknikipal extends CI_Controller{
   ...
   public  function index(){
		...
		$data['teknik_by_date'] = $this->t_teknik->get_data_by_date_ipal($data['name'], $data['product'], $data['min'], $data['max']);
		$data['client'] = $this->t_teknik->get_data_client()->result();
		$data['product'] = $this->t_teknik->get_data_product_ipal()->result();
		...
		$this->load->view('pages/teknik/ipal/datatable',$data);
